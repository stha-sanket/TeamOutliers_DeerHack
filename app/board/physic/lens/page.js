...
//     function calculateImageDistance(type, uVal, fVal) {
//         const f = type === "convex" ? fVal : -fVal;
//         const u = -uVal;
//         if (u + f === 0) return Infinity;
//         return (f * u) / (u + f);
//     }
...
//         // Image
//         const imageDistance = calculateImageDistance(lensType, objectDistance, focalLength);
